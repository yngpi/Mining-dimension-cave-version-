...
package net.mcreator.miningdimensioncaveversion.world.dimension;
...
public class Miningdimension1Dimension {
	...
	public static class Fixers {
		...
		public static void registerFillerBlocks(FMLCommonSetupEvent event) {
			...
			replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("mining_dimension_cave_version:miningdimensionlll"))
		...
		public static void registerDimensionSpecialEffects(FMLClientSetupEvent event) {
			...
			event.enqueueWork(
					() -> DimensionSpecialEffects.EFFECTS.put(new ResourceLocation("mining_dimension_cave_version:miningdimension_1"), customEffect));
		}
	}
}
