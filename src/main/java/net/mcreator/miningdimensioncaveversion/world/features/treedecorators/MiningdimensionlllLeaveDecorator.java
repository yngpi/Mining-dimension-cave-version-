...
public class MiningdimensionlllLeaveDecorator extends LeaveVineDecorator {
	public static final MiningdimensionlllLeaveDecorator INSTANCE = new MiningdimensionlllLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("miningdimensionlll_tree_leave_decorator");
