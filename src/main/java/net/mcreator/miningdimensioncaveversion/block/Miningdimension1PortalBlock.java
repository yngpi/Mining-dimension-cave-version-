...
package net.mcreator.miningdimensioncaveversion.block;
...
import net.mcreator.miningdimensioncaveversion.world.teleporter.Miningdimension1Teleporter;
import net.mcreator.miningdimensioncaveversion.world.teleporter.Miningdimension1PortalShape;

import java.util.Random;
import java.util.Optional;

public class Miningdimension1PortalBlock extends NetherPortalBlock {
	public Miningdimension1PortalBlock() {
		super(BlockBehaviour.Properties.of(Material.PORTAL).noCollission().randomTicks().strength(-1.0F).sound(SoundType.GLASS).lightLevel(s -> 2)
				.noDrops());
		setRegistryName("miningdimension_1_portal");
	}
	...
	public static void portalSpawn(Level world, BlockPos pos) {
		Optional<Miningdimension1PortalShape> optional = Miningdimension1PortalShape.findEmptyPortalShape(world, pos, Direction.Axis.X);
	...
	public BlockState updateShape(BlockState p_54928_, Direction p_54929_, BlockState p_54930_, LevelAccessor p_54931_, BlockPos p_54932_,
		...
		return !flag && !p_54930_.is(this) && !(new Miningdimension1PortalShape(p_54931_, p_54932_, direction$axis1)).isComplete()
		...
		if (!entity.isPassenger() && !entity.isVehicle() && entity.canChangeDimensions() && !entity.level.isClientSide() && true) {
			if (entity.isOnPortalCooldown()) {
				entity.setPortalCooldown();
					...
					new ResourceLocation("mining_dimension_cave_version:miningdimension_1"))) {
				entity.setPortalCooldown();
				teleportToDimension(entity, pos,
						ResourceKey.create(Registry.DIMENSION_REGISTRY, new ResourceLocation("mining_dimension_cave_version:miningdimension_1")));
			} else {
				entity.setPortalCooldown();
	...
	private void teleportToDimension(Entity entity, BlockPos pos, ResourceKey<Level> destinationType) {
		entity.changeDimension(entity.getServer().getLevel(destinationType),
				new Miningdimension1Teleporter(entity.getServer().getLevel(destinationType), pos));
	}
}
